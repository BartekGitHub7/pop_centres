...
class CentreManager:
    ...
    def add_reservation(self):
        ...
        if reservation_name:
            selected_client_index = self.listbox_clients.curselection()
            if selected_client_index:
                selected_client = self.selected_centre['clients'][selected_client_index[0]]
                selected_client['reservation'].append(reservation_name)
                self.listbox_reservations.insert(END, reservation_name)
                self.show_client_reservations_on_map()  # Aktualizacja markerów
    ...
    def remove_reservation(self):
        ...
        selected_client = self.selected_centre['clients'][selected_client_index[0]]
        del selected_client['reservation'][selected_reservation_index[0]]

        # Aktualizacja listy rezerwacji w listboxie
    ...
    def edit_reservation(self):
        ...
        if new_reservation_name:
            selected_client = self.selected_centre['clients'][selected_client_index[0]]
            selected_client['reservation'][selected_reservation_index[0]] = new_reservation_name
