...
class CentreManager:
    def __init__(self, root):
        ...
        self.frame_details = Frame(root, width=600, height=800, padx=10, pady=10)
    ...
    def setup_list_frame(self):
        ...
        self.listbox_centres = Listbox(self.frame_list, width=30, height=30)
    ...
    def setup_details_frame(self):
        ...
        self.button_show_reservations.grid(row=2, column=1, sticky=W, pady=5)
        ...
        self.entry_reservation_name.grid(row=7, column=0, columnspan=4, pady=5)
        ...
        self.button_update_reservation.grid(row=8, column=2, columnspan=2, pady=5)
